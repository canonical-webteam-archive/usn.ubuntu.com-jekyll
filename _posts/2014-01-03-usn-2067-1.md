---
layout: post
title: "USN-2067-1&#58; Linux kernel (OMAP4) vulnerabilities"
permalink: /usn/usn-2067-1/index.html
...
Catalin Marinas reported a flaw in the get_user and put_user API functions in the Linux kernel on ARM platforms. An unprivileged local user could exploit this flaw to gain administrator privileges. ([CVE-2013-6282](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-6282))
...
Ubuntu 12.04 LTS
 : [linux-image-3.2.0-1442-omap4](https://launchpad.net/ubuntu/+source/linux-ti-omap4) <span> [3.2.0-1442.61](https://launchpad.net/ubuntu/+source/linux-ti-omap4/3.2.0-1442.61) </span> 
...
### References
 ...
 [CVE-2013-6282](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-6282), 
