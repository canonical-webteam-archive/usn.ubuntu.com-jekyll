---
layout: post
title: "USN-1995-1&#58; Linux kernel (Raring HWE) vulnerabilities"
permalink: /usn/usn-1995-1/index.html
...
Kees Cook discovered an information leak in the Linux kernel&#39;s Human Interface Device (HID) subsystem when CONFIG_HID_SENSOR_HUB is enabled. A physically proximate attacker could obtain potentially sensitive information from kernel memory via a specially crafted device. ([CVE-2013-2898](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-2898))
...
A flaw was discovered in how the Linux Kernel&#39;s networking stack checks scm credentials when used with namespaces. A local attacker could exploit this flaw to gain privileges. ([CVE-2013-4300](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-4300)) 
...
Ubuntu 12.04 LTS
 : [linux-image-3.8.0-32-generic](https://launchpad.net/ubuntu/+source/linux-lts-raring) <span> [3.8.0-32.47~precise1](https://launchpad.net/ubuntu/+source/linux-lts-raring/3.8.0-32.47~precise1) </span> 
...
### References
 ...
 [CVE-2013-2898](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-2898), 

 [CVE-2013-2899](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-2899), 

 [CVE-2013-4300](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-4300)
