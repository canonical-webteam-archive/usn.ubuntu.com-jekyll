---
layout: post
title: "USN-2971-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-2971-1/index.html
...
Ubuntu 15.10
 : [linux-image-4.2.0-36-generic-lpae](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
 : [linux-image-4.2.0-36-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
 : [linux-image-4.2.0-36-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
 : [linux-image-4.2.0-36-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
 : [linux-image-4.2.0-36-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
 : [linux-image-4.2.0-36-lowlatency](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
 : [linux-image-4.2.0-36-generic](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-36.41](https://launchpad.net/ubuntu/+source/linux/4.2.0-36.41) </span> 
