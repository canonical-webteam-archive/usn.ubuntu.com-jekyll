---
layout: post
title: "USN-1809-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-1809-1/index.html
...
Ubuntu 12.04 LTS
 : [linux-image-3.2.0-41-virtual](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
 : [linux-image-3.2.0-41-generic-pae](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
 : [linux-image-3.2.0-41-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
 : [linux-image-3.2.0-41-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
 : [linux-image-3.2.0-41-omap](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
 : [linux-image-3.2.0-41-generic](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
 : [linux-image-3.2.0-41-highbank](https://launchpad.net/ubuntu/+source/linux) <span> [3.2.0-41.66](https://launchpad.net/ubuntu/+source/linux/3.2.0-41.66) </span> 
