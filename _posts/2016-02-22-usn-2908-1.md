---
layout: post
title: "USN-2908-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-2908-1/index.html
...
Ubuntu 15.10
 : [linux-image-4.2.0-30-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
 : [linux-image-4.2.0-30-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
 : [linux-image-4.2.0-30-lowlatency](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
 : [linux-image-4.2.0-30-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
 : [linux-image-4.2.0-30-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
 : [linux-image-4.2.0-30-generic-lpae](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
 : [linux-image-4.2.0-30-generic](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-30.35](https://launchpad.net/ubuntu/+source/linux/4.2.0-30.35) </span> 
