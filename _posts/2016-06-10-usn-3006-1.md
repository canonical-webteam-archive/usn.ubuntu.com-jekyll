---
layout: post
title: "USN-3006-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-3006-1/index.html
...
Ubuntu 16.04 LTS
 : [linux-image-4.4.0-24-generic](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
 : [linux-image-4.4.0-24-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
 : [linux-image-4.4.0-24-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
 : [linux-image-4.4.0-24-generic-lpae](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
 : [linux-image-4.4.0-24-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
 : [linux-image-4.4.0-24-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
 : [linux-image-4.4.0-24-lowlatency](https://launchpad.net/ubuntu/+source/linux) <span> [4.4.0-24.43](https://launchpad.net/ubuntu/+source/linux/4.4.0-24.43) </span> 
