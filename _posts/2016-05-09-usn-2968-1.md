---
layout: post
title: "USN-2968-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-2968-1/index.html
...
Ubuntu 14.04 LTS
 : [linux-image-3.13.0-86-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-generic-lpae](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-lowlatency](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-generic](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
 : [linux-image-3.13.0-86-powerpc-e500](https://launchpad.net/ubuntu/+source/linux) <span> [3.13.0-86.130](https://launchpad.net/ubuntu/+source/linux/3.13.0-86.130) </span> 
