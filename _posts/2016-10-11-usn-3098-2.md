---
layout: post
title: "USN-3098-2&#58; Linux kernel (Trusty HWE) vulnerabilities"
permalink: /usn/usn-3098-2/index.html
...
Ubuntu 12.04 LTS
 : [linux-image-3.13.0-98-generic-lpae](https://launchpad.net/ubuntu/+source/linux-lts-trusty) <span> [3.13.0-98.145~precise1](https://launchpad.net/ubuntu/+source/linux-lts-trusty/3.13.0-98.145~precise1) </span> 
 : [linux-image-3.13.0-98-generic](https://launchpad.net/ubuntu/+source/linux-lts-trusty) <span> [3.13.0-98.145~precise1](https://launchpad.net/ubuntu/+source/linux-lts-trusty/3.13.0-98.145~precise1) </span> 
