---
layout: post
title: "USN-3161-4&#58; Linux kernel (Qualcomm Snapdragon) vulnerabilities"
permalink: /usn/usn-3161-4/index.html
...
Ubuntu 16.04 LTS
 : [linux-image-snapdragon](https://launchpad.net/ubuntu/+source/linux-snapdragon) <span> [4.4.0.1042.34](https://launchpad.net/ubuntu/+source/linux-snapdragon/4.4.0-1042.46) </span> 
 : [linux-image-4.4.0-1042-snapdragon](https://launchpad.net/ubuntu/+source/linux-snapdragon) <span> [4.4.0-1042.46](https://launchpad.net/ubuntu/+source/linux-snapdragon/4.4.0-1042.46) </span> 
