---
layout: post
title: "USN-2847-1&#58; Linux kernel (Trusty HWE) vulnerabilities"
permalink: /usn/usn-2847-1/index.html
...
Ubuntu 12.04 LTS
 : [linux-image-3.13.0-74-generic](https://launchpad.net/ubuntu/+source/linux-lts-trusty) <span> [3.13.0-74.118~precise1](https://launchpad.net/ubuntu/+source/linux-lts-trusty/3.13.0-74.118~precise1) </span> 
 : [linux-image-3.13.0-74-generic-lpae](https://launchpad.net/ubuntu/+source/linux-lts-trusty) <span> [3.13.0-74.118~precise1](https://launchpad.net/ubuntu/+source/linux-lts-trusty/3.13.0-74.118~precise1) </span> 
