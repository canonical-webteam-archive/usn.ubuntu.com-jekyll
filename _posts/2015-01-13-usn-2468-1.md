---
layout: post
title: "USN-2468-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-2468-1/index.html
...
Ubuntu 14.10
 : [linux-image-3.16.0-29-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
 : [linux-image-3.16.0-29-lowlatency](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
 : [linux-image-3.16.0-29-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
 : [linux-image-3.16.0-29-generic-lpae](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
 : [linux-image-3.16.0-29-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
 : [linux-image-3.16.0-29-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
 : [linux-image-3.16.0-29-generic](https://launchpad.net/ubuntu/+source/linux) <span> [3.16.0-29.39](https://launchpad.net/ubuntu/+source/linux/3.16.0-29.39) </span> 
