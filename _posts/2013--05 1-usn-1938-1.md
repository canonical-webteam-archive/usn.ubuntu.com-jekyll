---
layout: post
title: "USN-1938-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-1938-1/index.html
category:  ubuntu-13.04
date: 2013--05 12:00:00
excerpt: |
    Vasily Kulikov discovered a flaw in the Linux Kernel&#39;s perf tool that allows specified to be run as root. A local could exploit this flaw to run commands as root when using the perf tool. user could exploit this ([CVE-2013-1060](http://people.ubuntu.com/~ubuntu-security/cve/CVE-2013-1060))
...
Ubuntu 13.04
 : [linux-image-3.8.0-30-generic](https://launchpad.net/ubuntu/+source/linux) <span> [3.8.0-30.44](https://launchpad.net/ubuntu/+source/linux/3.8.0-30.44) </span> 
