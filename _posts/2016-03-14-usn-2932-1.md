---
layout: post
title: "USN-2932-1&#58; Linux kernel (Vivid HWE) vulnerabilities"
permalink: /usn/usn-2932-1/index.html
...
Ubuntu 14.04 LTS
 : [linux-image-3.19.0-56-powerpc-smp](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
 : [linux-image-3.19.0-56-generic-lpae](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
 : [linux-image-3.19.0-56-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
 : [linux-image-3.19.0-56-lowlatency](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
 : [linux-image-3.19.0-56-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
 : [linux-image-3.19.0-56-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
 : [linux-image-3.19.0-56-generic](https://launchpad.net/ubuntu/+source/linux-lts-vivid) <span> [3.19.0-56.62~14.04.1](https://launchpad.net/ubuntu/+source/linux-lts-vivid/3.19.0-56.62~14.04.1) </span> 
