---
layout: post
title: "USN-2890-1&#58; Linux kernel vulnerabilities"
permalink: /usn/usn-2890-1/index.html
...
Ubuntu 15.10
 : [linux-image-4.2.0-27-lowlatency](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
 : [linux-image-4.2.0-27-generic-lpae](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
 : [linux-image-4.2.0-27-powerpc-e500mc](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
 : [linux-image-4.2.0-27-powerpc64-emb](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
 : [linux-image-4.2.0-27-powerpc-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
 : [linux-image-4.2.0-27-powerpc64-smp](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
 : [linux-image-4.2.0-27-generic](https://launchpad.net/ubuntu/+source/linux) <span> [4.2.0-27.32](https://launchpad.net/ubuntu/+source/linux/4.2.0-27.32) </span> 
